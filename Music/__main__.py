...
async def load_start():
    ...
    if restart_data:
        print("[INFO]: SENDING RESTART STATUS TO STARZ SERVER")
        try:
    ...
    await client.send_message(LOG_GROUP_ID, "Assistant Of Florenza Music Started")
    print("[INFO]: STARTED THE FLORENZA BOT AND SENDING THE INFO TO STARZ SERVER")
